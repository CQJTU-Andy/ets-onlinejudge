        ...
        $.ajax=function(opt){
            ...
            var _opt = $.extend(opt, {
                ...
                error: function (xhr,textStatus,errorThrown) {
                    if(xhr.status === 401){
                        window.location.href = $tool.getResUrl()+"manage/page/system/401.html";
                        return ;
                        ...
                        window.parent.parent.parent.parent.location.href = $tool.getResUrl()+"manage/login.html";

                        return ;
                    }else if(xhr.status === 404){
                        window.location.href = $tool.getResUrl()+"manage/page/system/404.html";
                        return ;
                    }
                ...
                //成功返回拦截错误码非'0000'的情况
                success: function (data, textStatus) {
                    if( '0000' !== data.code && 200 !== data && '200' != data.code){//异常的统一处理
                        layer.msg(data.msg);
                        return;
                    }
